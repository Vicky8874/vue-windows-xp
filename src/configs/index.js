...
export const start_right=[
  ...
  {id:6,desktop:false,zIndex:0,className:'picture',component:picture,name:'我的圖片',display:false,img:new URL('/image/windows_desktop/picture.png',import.meta.url)},
  {id:7,desktop:false,zIndex:0,className:'music',component:music,name:'我的音樂',display:false,img:new URL('/image/windows_desktop/music.png',import.meta.url)},
  {id:2,desktop:false,zIndex:0,className:'computer',component:computer,name:'我的電腦',display:false,img:new URL('/image/windows_desktop/computer.png',import.meta.url)},
  {id:9,desktop:false,zIndex:0,className:'control',component:control,name:'控制台(C)',display:false,img:new URL('/image/windows_desktop/control.png',import.meta.url)},
