...
export default {
  setup() {
    ...
    const address=[
      {name:'桌面',img:new URL('/image/windows_xp_icon/desktop.png',import.meta.url)},
      {name:'共用文件',img:new URL('/image/windows_xp_icon/file.png',import.meta.url)},
    ...
    const disk=[
      {name:'我的音樂',img:new URL('/image/windows_desktop/music.png',import.meta.url)},
      {name:'我的圖片',img:new URL('/image/windows_desktop/picture.png',import.meta.url)},
    ]
    const clickCss=(val)=>{
